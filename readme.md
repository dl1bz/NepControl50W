...
The issue isn't a really issue (PA switched immediately back to OFF/bypass using SSB) - is a decision of the manufacturers device firmware design to protect the LPF against wrong band selection.
